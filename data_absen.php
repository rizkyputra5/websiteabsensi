                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                       ...
                       <li>
                            <a href="jadwal_meeting.php">
                                <i class="fas fa-table"></i>jadwal meeting
                            </a>
                        </li>
                        <li>
                            <a href="datauser.php">
        ...
        <div class="page-container">
            ...
            <!-- End Modal -->
                        ...
                        <div class="row m-t-30">
                            ...
                            <a href="hapus_semuadata.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus seluruh data</button></a>
                            <a href="cetak_absen.php"><button class="btn btn-danger">print</button></a>
                            </div>
